...
"  --tf-check            teacher-forced agreement over --ids in one sweep: how often\n"
"                        the argmax after positions 0..i matches id i+1. This is the\n"
"                        acceptance rate batched greedy verification would see, the\n"
"                        number a quantised-draft design stands on\n"
