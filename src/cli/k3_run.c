...
"\n"
"diagnostics:\n"
"  --tf-check             teacher-forced agreement over the --ids sequence in one\n"
"                         sweep: at each position, does argmax after 0..i match the\n"
"                         id the sequence actually continues with. The acceptance\n"
"                         rate batched greedy verification would see from a draft\n"
