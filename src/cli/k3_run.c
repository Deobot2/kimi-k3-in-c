...
"                        prediction i is the argmax after positions 0..i, compared to\n"
"                        the id the sequence actually continues with. This is the\n"
"                        acceptance rate a draft model would see under batched greedy\n"
"                        verification\n"
...
int main(int argc, char **argv)
{
    ...
    for (int i = 2; i < argc; i++) {
         ...
         * for any of them here could never be reached. Do not re-add one. */
