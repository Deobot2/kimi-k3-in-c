...
"                        for each position, does the model's argmax prediction match the\n"
"                        id the sequence actually continues with. This is the acceptance\n"
"                        rate a draft model would see under batched greedy verification,\n"
"                        the number a quantised-draft design stands on\n"
