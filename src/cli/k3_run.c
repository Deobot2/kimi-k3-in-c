...
int main(int argc, char **argv)
{
    ...
    for (int i = 2; i < argc; i++) {
        ...
        /* --help/-h, --version and --list-presets are NOT handled here: the pre-scan
         * above already covers every index this loop sees (it starts at argv[1], this
         * loop at argv[2]), so a branch for them here could never be taken. */
