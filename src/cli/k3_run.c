...
int main(int argc, char **argv)
{
    ...
    for (int i = 2; i < argc; i++) {
        ...
        /* --help/-h, --version and --list-presets are not re-checked here: the pre-scan
         * above already covers every argv position, this loop's included, so by the
         * time we get here none of the remaining arguments can be one of them. */
